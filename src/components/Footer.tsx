        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href={whatsappLink('Olá! Vim pelo site Frutíferas Orgânicas.')} target="_blank" rel="noopener noreferrer" className="text-cream-200 hover:text-terracotta-100 transition" title="WhatsApp">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
