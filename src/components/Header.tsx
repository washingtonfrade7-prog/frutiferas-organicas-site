      ...
      <div className="bg-forest-900 text-cream-100 text-sm">
        <div className="max-w-7xl mx-auto px-4 py-1.5 flex justify-between items-center">
          <div className="flex gap-4">
            <a
              href={whatsappLink('Olá! Vim pelo site Frutíferas Orgânicas.')}
              target="_blank"
            ...
            <a
              ...
              className="hover:underline hidden sm:flex items-center gap-1 transition-colors hover:text-terracotta-100"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
