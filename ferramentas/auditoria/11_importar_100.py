...
# Nomes cientificos (por nome normalizado do master). Revisar quando possivel.
CIENTIFICOS = {
    "jabuticaba hibrida": "Plinia cauliflora",
    "jabuticaba branca": "Plinia cauliflora",
    "jabuticaba sabara": "Plinia cauliflora",
    ...
    "grumixama preta": "Eugenia brasiliensis",
    "amora preta tupy": "Rubus spp.",
    "amora portuguesa": "Rubus ulmifolius",
    "cambuci": "Campomanesia phaea",
    "cambui roxo": "Myrciaria tenella",
    "laranja champagne": "Citrus sinensis",
    "laranja abacaxi": "Citrus sinensis",
    "laranja serra dagua": "Citrus sinensis",
    "laranja kinkan": "Citrus japonica",
    "bacuri": "Platonia insignis",
    "groselha": "Ribes spp.",
    "calabura": "Muntingia calabura",
    "pinha dos astecas": "Annona sp.",
    "ananas do mato": "Ananas bracteatus",
    "uvaia": "Eugenia pyriformis",
    "mandacaru": "Cereus jamacaru",
    "carambola mel": "Averrhoa carambola",
    "ajuru preto branco": "Chrysobalanus icaco",
    "framboesa silvestre": "Rubus idaeus",
    "guabiroba do cerrado": "Campomanesia pubescens",
    "uva isabel": "Vitis labrusca",
    "uva goethe": "Vitis spp.",
    "uva brs vitoria": "Vitis spp.",
    "cambuca": "Plinia edulis",
    "pitomba da bahia": "Eugenia luschnathiana",
    "ubajai": "Eugenia myrcianthes",
    "limao doce tanjo": "Citrus limettioides",
    "manga palmer": "Mangifera indica",
    "manga uba": "Mangifera indica",
    "roma": "Punica granatum",
    "cagaita": "Eugenia dysenterica",
    "limao imperial": "Citrus limon",
    "limao siciliano": "Citrus limon",
    "limao cravo": "Citrus limonia",
    "limao caviar": "Citrus australasica",
    "limao galeguinho": "Citrus sp.",
    "tamarilho": "Solanum betaceum",
    "pitanga preta": "Eugenia uniflora",
    "pitanga do cerrado": "Eugenia calycina",
    "cherimoya": "Annona cherimola",
    "mamao": "Carica papaya",
    "bacupari de bico": "Garcinia gardneriana",
    "bacupari mirim": "Garcinia gardneriana",
    "cabeludinha roxa": "Myrciaria glazioviana",
    "cabeludinha peludinha": "Myrciaria glazioviana",
    "maca eva": "Malus domestica",
    "cupuacu": "Theobroma grandiflorum",
    "longan": "Dimocarpus longan",
    "rambuta": "Nephelium lappaceum",
    "biriba": "Rollinia mucosa",
    "inga de flores roseas": "Inga edulis",
    "camu-camu": "Myrciaria dubia",
    "ameixa vermelha": "Prunus salicina",
    "ameixa japao": "Prunus salicina",
    "cidra": "Citrus medica",
    "acerola okinawa": "Malpighia emarginata",
    "mexerica ponkan": "Citrus reticulata",
    "abacate": "Persea americana",
    "cacau": "Theobroma cacao",
    "mana cubiu": "Solanum sessiliflorum",
    "banana ouro": "Musa spp.",
    "pinha": "Annona squamosa",
    "mangostao": "Garcinia mangostana",
    "pessego anao": "Prunus persica",
    "pera dagua": "Pyrus communis",
    "araca roxo": "Psidium cattleianum",
    "araca amarelo": "Psidium cattleianum",
    "araca vermelho": "Psidium cattleianum",
    "araca pera": "Psidium acutangulum",
    "araca boi": "Psidium guineense",
    "goiaba amarela": "Psidium guajava",
    "goiaba paluma": "Psidium guajava",
    "atemoia": "Annona x atemoya",
    "dovyalis doce campari": "Dovyalis hebecarpa",
    "pitaya branca": "Hylocereus undatus",
    "pitaya vermelha": "Hylocereus polyrhizus",
    "pitaya amarela": "Hylocereus megalanthus",
    "mirtilo blueberry": "Vaccinium myrtillus",
    "graviola": "Annona muricata",
    "figo": "Ficus carica",
    "maracuja gigante": "Passiflora edulis",
    "caja manga anao": "Spondias dulcis",
    "nectarina": "Prunus persica",
    "fruta do milagre": "Synsepalum dulcificum",
    "melao andino": "Solanum muricatum",
    "saborosa pytaya do serrado": "Hylocereus sp.",
}
